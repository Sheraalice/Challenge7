const emailTemplate = (link) => {
    ...
    <div style="background-color: #ffffff; padding: 20px; border-radius: 8px; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1); width: 300px;">
        ...
        <p style="color: #4b5563; margin-bottom: 20px;">Jika Anda tidak meminta reset password, Anda dapat menghiraukan email ini.</p><p style="color: #f56565; font-size: 0.8rem; margin-bottom: 20px;">Link reset password akan kadaluarsa dalam 1 jam.</p>
